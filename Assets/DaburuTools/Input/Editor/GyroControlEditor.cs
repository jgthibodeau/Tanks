...
namespace DaburuTools
{
	namespace Input
	{
		...
		public class GyroControlEditor : Editor
		{
			...
			private SerializedProperty mSP_useLocalRotation;
			...
			private GUIContent useLocalRotationContent;
			...
			private void OnEnable()
			{
				...
				mSP_useLocalRotation		= serializedObject.FindProperty("useLocalRotation");
				...
				useLocalRotationContent			= new GUIContent("Use Local Rotation", "If true, sets local rotation using gyro");
			...
			public override void OnInspectorGUI()
			{
				...
				EditorGUILayout.PropertyField(mSP_useLocalRotation, useLocalRotationContent);
