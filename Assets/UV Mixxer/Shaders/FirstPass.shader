Shader "Nature/Terrain/Diffuse (UV Mixing)" {
	Properties {
	...
	Dependency "AddPassShader" = "Hidden/TerrainEngine/Splatmap/DiffuseUVMixing-AddPass"
	Dependency "BaseMapShader" = "Hidden/TerrainEngine/Splatmap/DiffuseUVMixing-Base"
